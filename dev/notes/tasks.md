---
calmmage_id: OnxHu93v
---
- a
    - `key: 1d7ead96`
    - Rename all image files to contain meaning key
- b
    - `key: 0306abdd`
    - Make feature words button more prominent, move to main settings maybe
- c
    - `key: 9a245244`
    - Make russian a primary language by default
- d
    - `key: a5c5f25c`
